...
class SubmarineBattleEnv(gym.Env):
    """
    Entorno básico de batalla submarina en un grid 10x10.
    ...
    def __init__(self, render_mode=None):
        ...
        # [x1,y1, x2,y2, xc,yc, xd,yd], cada coordenada entre 0 y 9
    ...
    def _clip_position(self, pos):
        """Asegura que una posición permanezca dentro del grid [0, 9]."""
